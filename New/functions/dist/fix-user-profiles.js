...
async function fixUserProfiles() {
    ...
    try {
        ...
        await databases.createBooleanAttribute(DATABASE_ID, COLLECTION_ID, 'steamLinked', false, // required
        false // default value
        );
    ...
    try {
        ...
        await databases.createStringAttribute(DATABASE_ID, COLLECTION_ID, 'steamId', 50, // size
        false // required
        );
